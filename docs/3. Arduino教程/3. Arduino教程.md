...
根据库文件的路径打开库文件夹，选中库文件夹中 .zip格式的”**Rtc_by_Makuna.zip**“库压缩包，然后单击“**打开**”，库文件成功加入。
...
根据库文件的路径打开库文件夹，选中库文件夹中 .zip格式的”**TM1650.zip**“库压缩包，然后单击“**打开**”，库文件成功加入。
...
根据库文件的路径打开库文件夹，选中库文件夹中 .zip格式的”**HT16K33_Lib_For_ESP32.zip**“库压缩包，然后单击“**打开**”，库文件成功加入。
